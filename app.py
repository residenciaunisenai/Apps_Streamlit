...
class AnomalyClassifier:
    ...
    def classificar_anomalia(self, score_anomalia, confianca=0.0, modelo="Unknown"):
        """
        ...
        """
        # Encontra defeito baseado no score (usando hash para distribuição)
        defeito_match = self._mapear_para_defeito(score_anomalia)
    ...
    def _mapear_para_defeito(self, score):
        ...
        # Usa o score como seed para selecionar defeito de forma determinística mas variada
        # Isso garante que imagens diferentes com scores diferentes tenham defeitos diferentes
        ...
        try:
            ...
            if is_anomaly:
                ...
                try:
                    ...
                    confianca = min((score - detector.threshold) / detector.threshold, 1.0)
