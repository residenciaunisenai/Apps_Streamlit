...
- **Classificação Automática de 41 Defeitos**: Extrai o tipo de defeito do nome do arquivo
...
├── autoencoder_model.pkl  # Modelo Autoencoder treinado
...
O sistema classifica automaticamente anomalias em **41 tipos de defeitos** extraindo o nome do defeito diretamente do nome do arquivo da imagem.

### Tipos de Defeitos Suportados:
- Dimensional (entrepernas assimétrico)
- Falha no tecido (1-4)
- Furo e rasgo (bolso, corpo, cós)
- Ponto quebrado (bolso, cós, lateral)
- Sem resistência (1-6)
- Sujo/mancha (1-7)
- Tecido escapando (gancho, lateral, passante, barra, bolso)
- Tonalidade entre partes/peças

### Formato do Nome do Arquivo:
```
nome_do_defeito_func1_augmentation.jpg
```
Exemplo: `Dimensional - Entrepernas assimetrico - lavado_func1_hflip.jpg`

### Informações por Defeito:
